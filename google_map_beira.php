...
zoom="15" zoom-control-options="{style:'LARGE', position:'LEFT_CENTER'}" center="[-19.833393, 34.836934]"      
  ...
  <!-- Dalima Sede -->
     ...
     <custom-marker title="DALIMA" position="[-25.968468, 32.564084]" on-click="map.showInfoWindow(event, 'Dalima')">
        <div>
            <img src="img/office-dalima.svg" style="width:127px"/>
        </div>
    </custom-marker>	
...
<img src="http://www.dalima.co.mz/wp-content/uploads/2017/01/DALIMA-Locais_Beira.jpg" style="width:200px;"/>
			...
			<p style="position: relative;top: -8px;}">Rua Poder Popular/ Major Serpa</p>
          </div>
        </div>
      </info-window>
	...
	<info-window id="BEIRAOFFICE" max-width="200">
        <div ng-non-bindable>
            <p><strong>DALIMA | Publicidade Digital Outdoor</strong></p>
			<p style="position: relative;top: -8px;}">143 R/c Sala 2, General Machado, Beira</p>
          </div>
        </div>
      </info-window>
