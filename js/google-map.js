    ...
    apiLoad(
      [
        ...
        [
          ...
          [
            [
              "https://khms0.googleapis.com/kh?v=711\u0026hl=pt-BR\u0026",
              "https://khms1.googleapis.com/kh?v=711\u0026hl=pt-BR\u0026",
            ],
            null,
            null,
            null,
            ...
            "711",
            [
              "https://khms0.google.com/kh?v=711\u0026hl=pt-BR\u0026",
              "https://khms1.google.com/kh?v=711\u0026hl=pt-BR\u0026",
            ],
          ],
          null,
          null,
          ...
          [
            [
              "https://khms0.googleapis.com/kh?v=102\u0026hl=pt-BR\u0026",
              "https://khms1.googleapis.com/kh?v=102\u0026hl=pt-BR\u0026",
            ],
            null,
            null,
            null,
            ...
            "102",
            [
              "https://khms0.google.com/kh?v=102\u0026hl=pt-BR\u0026",
              "https://khms1.google.com/kh?v=102\u0026hl=pt-BR\u0026",
            ],
          ],
          [
            [
              "https://mts0.googleapis.com/mapslt?hl=pt-BR\u0026",
              "https://mts1.googleapis.com/mapslt?hl=pt-BR\u0026",
            ],
          ],
          null,
          null,
        ...
        [
          "https://maps.google.com/maps-api-v3/api/js/27/8/intl/pt_br",
          "3.27.8",
        ],
        [3068438762],
        1,
        ...
        null,
        "",
        ["placeses", "visualization", "drawing", "geometry", "places"],
        null,
        1,
        "https://khms.googleapis.com/mz?v=711\u0026",
        null,
        ...
        [
          "https://www.google.com/maps/api/js/master?pb=!1m2!1u27!2s8!2spt-BR!3sUS!4s27/8/intl/pt_br",
          "https://www.google.com/maps/api/js/widget?pb=!1m2!1u27!2s8!2spt-BR",
        ],
        null,
        0,
        null,
...
(function (_) {
  ...
  sc = function (a) {
    ...
    try {
      _.Hb({ height: _.nc, width: _.nc }, !0)(a);
    } catch (b) {
  ...
  Uc = function () {
    var a = _.Qc.f,
      a = Rc(a);
    !_.Ba(_.Nc.setImmediate) ||
    (_.Nc.Window &&
      _.Nc.Window.prototype &&
      !_.Jc("Edge") &&
      _.Nc.Window.prototype.setImmediate == _.Nc.setImmediate)
      ? (Sc || (Sc = Tc()), Sc(a))
      : _.Nc.setImmediate(a);
  };
  Tc = function () {
  ...
  Ed = function (a, b, c) {
    for (var d = 1; d < b.A.length; ++d) {
      var e = b.A[d],
        f = a[d + b.b];
      if (e && null != f)
        if (3 == e.label) for (var g = 0; g < f.length; ++g) Dd(f[g], d, e, c);
        else Dd(f, d, e, c);
    }
  };
  Dd = function (a, b, c, d) {
  ...
  De = function (a) {
    var b;
    _.xa(a) || a instanceof _.yc
      ? 0 == _.w(a)
        ? (b = !0)
        : ((b = a instanceof _.yc ? a.getAt(0) : a[0]),
          (b = _.xa(b) || b instanceof _.yc))
      : (b = !1);
    return b
      ? a instanceof _.yc
        ? Ce(Ae)(a)
  ...
  ug = function (a, b) {
    ...
    _.R &&
      sg(e.useStaticMap, a) &&
      ((g = new Jf(f, _.tg, _.P(_.pf(_.R), 9), new dd(null))),
  ...
  _.z.addDomListener = function (a, b, c, d) {
    if (a.addEventListener) {
      ...
      a.attachEvent
        ? ((c = new wb(a, b, c, 2)), a.attachEvent("on" + b, xb(c)))
        : ((a["on" + b] = c), (c = new wb(a, b, c, 3)));
    return c;
  };
  _.z.addDomListenerOnce = function (a, b, c, d) {
    var e = _.z.addDomListener(
      a,
      b,
      function () {
        e.remove();
  ...
  _.A.prototype.unbind = function (a) {
    var b = Db(this),
      c = b[a];
    c &&
      (c.zg && delete zb(c.Bc, c.ab)[_.yb(c.zg)],
      (this[a] = this.get(a)),
      (b[a] = null));
  };
  ...
  var Wg = { To: "Point", Ro: "LineString", POLYGON: "Polygon" };
  _.t(Eb, Error);
  var Xg, Zg;
  ...
  Zc.prototype.addListener = function (a, b, c) {
    ...
    e = this.P;
    var f = Ra(e, Yc(a, b));
    (e = 0 > f ? null : _.za(e) ? e.charAt(f) : e[f])
      ? (e.once = e.once && c)
      : this.P.push({ yc: a, context: b || null, once: c });
    d && this.f();
    return a;
  };
  ...
  _.Th =
    Uh && _.Eh
      ? Jd() ||
        ("CSS1Compat" == Uh.compatMode ? (0, window.parseInt)(_.Kd, 10) : 5)
      : void 0;
  _.Vh = _.Jc("Firefox");
  _.Wh = _.Fd() || _.Jc("iPod");
  _.Xh = _.Jc("iPad");
  _.Yh =
    _.Jc("Android") &&
    !(Lc() || _.Jc("Firefox") || _.Jc("Opera") || _.Jc("Silk"));
  _.Zh = Lc();
  ...
  var ci = _.Ob(
    _.Hb({ placeId: _.ah, query: _.ah, location: _.Yb }),
    function (a) {
    ...
    label: _.Pb(
      _.Nb([
        _.Yg,
        {
          Zf: Qb("text"),
          then: _.Hb(
            { text: _.Yg, fontSize: _.ah, fontWeight: _.ah, fontFamily: _.ah },
            !0
          ),
        },
      ])
      ...
      if (
        ...
        if (f) {
          ...
          if (!Ni) {
            ...
            b = _.K(b, Bi);
            f = new Hf([]);
            Ci || ((Ci = { b: -1, A: [] }), (Ci.A = [, _.qh, _.qh, _.xd(1)]));
            f = _.K(f, Ci);
            g = new Ff([]);
            if (!Ai) {
              var h = [];
  ...
  var cg;
  _.qg =
    "StopIteration" in _.Nc
      ? _.Nc.StopIteration
      : { message: "StopIteration", stack: "" };
  _.eg.prototype.next = function () {
    throw _.qg;
  };
  _.eg.prototype.Oe = function () {
    return this;
  };
  _.fg.prototype.pf = !0;
  ...
  mg.prototype.splice = function (a) {
    ...
    this.b = !this.b;
    for (
      var c = _.ya(arguments[0]) ? arguments[0] : arguments, d = c.length - 1;
      0 <= d;
      d--
    )
      _.kg(c[d], b);
  ...
  _.k.releaseTile = function (a) {
    a &&
      this.b.contains(a) &&
      (this.b.remove(a), (a = a.__gmimt.Kb) && a.release());
  };
  _.k.df = _.ta(15);
...
google.maps.__gjsload__("visualization", function (_) {
  var ix = function (a) {
      return _.db(a) && null != a
        ? a instanceof _.E
          ? !0
          : a.location instanceof _.E && (!a.weight || _.x(a.weight))
        : !1;
    },
    jx = _.oa(),
    kx = function (a) {
      this.set("data", new _.yc());
      this.setValues(a);
    },
    lx = function (a) {
      this.setValues(a);
  ...
  _.t(jx, _.A);
  _.t(kx, jx);
  kx.prototype.setData = function (a) {
    if (!(_.xa(a) || a instanceof _.yc)) throw _.Fb("not an Array or MVCArray");
    _.m(a.getLength) || (a = new _.yc(a));
    _.Lb(ix)(a.getArray());
    this.set("data", a);
  };
  kx.prototype.map_changed = function () {
    var a = this;
    _.F("visualization_impl", function (b) {
      b.b(a);
    });
  };
  _.wc(kx.prototype, { map: _.gi, data: null });
  _.t(lx, _.A);
  _.wc(lx.prototype, {
    layerId: _.ah,
    layerKey: _.ah,
  ...
  _.Nc.google.maps.visualization = {
    DynamicMapsEngineLayer: lx,
    HeatmapLayer: kx,
    MapsEngineLayer: mx,
    MapsEngineStatus: {
      OK: _.ia,
...
google.maps.__gjsload__("drawing", function (_) {
  ...
  _.t(Iw, _.A);
  _.wc(Iw.prototype, { map: _.gi, drawingMode: _.ah });
  _.Nc.google.maps.drawing = {
    DrawingManager: Iw,
    OverlayType: {
      MARKER: "marker",
      POLYGON: "polygon",
...
google.maps.__gjsload__("geometry", function (_) {
  var Mw = function (a, b) {
      return Math.abs(_.Za(b - a, -180, 180));
    },
    Nw = function (a, b, c, d, e) {
      if (!d) {
        c = Mw(a.lng(), c) / Mw(a.lng(), b.lng());
        if (!e)
          return (
            (e = Math.sin(_.Rb(a.lat()))),
    ...
    Qw = {
      containsLocation: function (a, b) {
        for (
          ...
          for (var n = e.getAt(h), q = 0, r = n.getLength(); q < r; ++q) {
            var u = n.getAt(q),
              y = n.getAt((q + 1) % r),
              B = _.Za(u.lng(), -180, 180),
              D = _.Za(y.lng(), -180, 180),
              C = Math.max(B, D),
              B = Math.min(B, D);
            (180 < C - B ? c >= C || c < B : c < C && c >= B) &&
              Nw(u, y, c, d, f) < a.lat() &&
              (g = !g);
          }
      ...
      isLocationOnEdge: function (a, b, c) {
        ...
        for (var h = 0, l = g.getLength(); h < l; ++h)
          for (
            var n = g.getAt(h), q = n.getLength(), r = e ? q : q - 1, u = 0;
            u < r;
            ++u
          ) {
            var y = n.getAt(u),
              B = n.getAt((u + 1) % q),
              D = _.Za(y.lng(), -180, 180),
              C = _.Za(B.lng(), -180, 180),
              G = Math.max(D, C),
              L = Math.min(D, C);
            if (
              (D =
                1e-9 >= Math.abs(_.Za(D - C, -180, 180)) &&
                (Math.abs(_.Za(D - d, -180, 180)) <= c ||
                  Math.abs(_.Za(C - d, -180, 180)) <= c))
            )
              var D = a.lat(),
                C = Math.min(y.lat(), B.lat()) - c,
                H = Math.max(y.lat(), B.lat()) + c,
                D = D >= C && D <= H;
            if (D) return !0;
            if (
              180 < G - L ? d + c >= G || d - c <= L : d + c >= L && d - c <= G
            )
              if (((y = Nw(y, B, d, f, b)), Math.abs(y - a.lat()) < c))
                return !0;
          }
        return !1;
      },
  ...
  var Rw = {
    ...
    computeOffset: function (a, b, c, d) {
      ...
      return new _.E(
        _.Sb(Math.asin(g)),
        _.Sb(a + Math.atan2(b * e * Math.sin(c), d - f * g))
      );
    },
    ...
    interpolate: function (a, b, c) {
      ...
      b = Rw.Ue(a, b);
      var n = Math.sin(b);
      if (1e-6 > n) return new _.E(a.lat(), a.lng());
      a = Math.sin((1 - c) * b) / n;
      c = Math.sin(c * b) / n;
    ...
    computeLength: function (a, b) {
      b = b || 6378137;
      var c = 0;
      a instanceof _.yc && (a = a.getArray());
      for (var d = 0, e = a.length - 1; d < e; ++d)
        c += Rw.computeDistanceBetween(a[d], a[d + 1], b);
      return c;
    },
    computeArea: function (a, b) {
      return Math.abs(Rw.computeSignedArea(a, b));
    },
    ...
    Mk: function (a, b, c) {
      return Rw.Nk(a, b, c) * Rw.Ul(a, b, c);
    },
    Nk: function (a, b, c) {
      var d = [a, b, c, a];
      a = [];
      for (c = b = 0; 3 > c; ++c) (a[c] = Rw.Ue(d[c], d[c + 1])), (b += a[c]);
      b /= 2;
      d = Math.tan(b / 2);
  ...
  var Sw = {
    ...
    encodePath: function (a) {
      a instanceof _.yc && (a = a.getArray());
      return Sw.nn(a, function (a) {
        return [Math.round(1e5 * a.lat()), Math.round(1e5 * a.lng())];
      });
    },
    nn: function (a, b) {
      for (var c = [], d = [0, 0], e, f = 0, g = _.w(a); f < g; ++f)
        (e = b ? b(a[f]) : a[f]),
          Sw.Oh(e[0] - d[0], c),
          Sw.Oh(e[1] - d[1], c),
          (d = e);
  ...
  _.Nc.google.maps.geometry = { encoding: Sw, spherical: Rw, poly: Qw };
  _.k = Pw.prototype;
  _.k.decodePath = Sw.decodePath;
  _.k.encodePath = Sw.encodePath;
  _.k.computeDistanceBetween = Rw.computeDistanceBetween;
  _.k.interpolate = Rw.interpolate;
  _.k.computeHeading = Rw.computeHeading;
  _.k.computeOffset = Rw.computeOffset;
  _.k.computeOffsetOrigin = Rw.computeOffsetOrigin;
  _.kc("geometry", new Pw());
});
...
google.maps.__gjsload__("places", function (_) {
  ...
  _.t(Xw, _.A);
  Xw.prototype.setTypes = _.uc("types", _.Lb(_.Yg));
  Xw.prototype.setComponentRestrictions = _.uc(
    "componentRestrictions",
    _.Hb({ country: _.Nb([_.Yg, _.Lb(_.Yg)]) }, !0)
  );
  _.wc(Xw.prototype, { place: null, bounds: _.Pb(_.ce) });
  Yw.prototype.getPlacePredictions = function (a, b) {
    _.F(
      "places_impl",
      (0, _.p)(function () {
  ...
  Yw.prototype.getPredictions = Yw.prototype.getPlacePredictions;
  Yw.prototype.getQueryPredictions = function (a, b) {
    _.F(
      "places_impl",
      (0, _.p)(function () {
  ...
  _.k.search = $w.prototype.nearbySearch;
  ...
  _.t(cx, _.A);
  _.wc(cx.prototype, { places: null, bounds: _.Pb(_.ce) });
